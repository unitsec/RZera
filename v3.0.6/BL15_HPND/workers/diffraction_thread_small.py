...
from BL15_HPND.workers.ui_mapping_small import diff_mapping
import json
    ...
    def start_reduction(self,window,diff_config,plot_list_dict,sam_list,filterbox,other_list,reduction):
        try:
            ...
            if getattr(sys, 'frozen', False):
                ...
                bl15_config = os.path.join(os.path.dirname(temp_dir), '..', 'CSNS_Alg','configure', 'BL15_small_base.json')
            ...
            self.reduction_thread = reduction_thread(diff_config,bl15_configure, self.redis_conf,plot_list_dict,sam_list,filterbox,other_list, self.online)
...
class reduction_thread(QThread):
    ...
    def __init__(self,diff_config,bl15_config, redis_config,plot_list_dict,sam_list,filterbox, other_list, online):
        ...
        # if self.diff_configure['mode'] == 'offline':
            try:
                ...
                for group in self.diff_configure["group_list"]:
                    ...
                    bl15 = CSNS_Diffraction(self.bl15_configure,self.diff_configure,group,self.online,
