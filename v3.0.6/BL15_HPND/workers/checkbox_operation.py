        ...
        try:
            ...
            if lineedit.isEnabled() and config is not None:
                ...
                if object_name.endswith('start'):
                    lineedit.setText(str(config['d_rebin'][object_name[:7]][0]))
                elif object_name.endswith('end'):
                    lineedit.setText(str(config['d_rebin'][object_name[:7]][1]))
                elif object_name.endswith('number'):
                    lineedit.setText(str(config['d_rebin'][object_name[:7]][2]))
            else:
                lineedit.setText('')
