# 功能代码，继承UI代码，给UI控件添加功能；groupMA对应MA
from PyQt5 import QtWidgets
from PyQt5 import QtGui
from PyQt5.QtCore import Qt
from BL15_HPND.ui.ui_BL15_diffraction_big import Ui_Form
...
from BL15_HPND.workers.ui_mapping_big import save_diff_config, load_diff_config
from BL15_HPND.workers.data_save import save_diff_big
import BL15_HPND.workers.diffraction_thread_big
import json
...
class diffraction_big(QtWidgets.QWidget, Ui_Form):
    def __init__(self, parent=None):
        super(diffraction_big, self).__init__(parent)
        self.setupUi(self)
        ...
        if getattr(sys, 'frozen', False):
            ...
            bl15_config = os.path.join(temp_dir, '..', 'CSNS_Alg', 'configure', 'BL15_big_base.json')
        ...
        #################################### 配置 d_rebin  #######################################################
        self.groupMA_start.setValidator(doubleValidator)  # 将doubleValidator设置到 QLineEdit 控件上(只能输入浮点数)
        ...
        self.groupMA_number.setValidator(self.nozerointvalidator)  # 将NonZeroIntValidator设置到 QLineEdit 控件上(只能输入正整数)
        ...
        ######################################### 配置 reduction button  ################################################
        self.reduction_thread = BL15_HPND.workers.diffraction_thread_big.start_reduction_thread()  # 实例化start_reduction_thread
        ...
        self.save_button.clicked.connect(lambda:
                                         save_diff_big(self, self.diff_config,
