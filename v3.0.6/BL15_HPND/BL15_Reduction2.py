from utils.ui import load_beamline_config,load_focused_data, normalization,interpolation,substraction_multiScale,division,save_reduced_data,d_rebin,AIndex,RongZai_Agent
...
class Reduction(RunWidget):
    def __init__(self, parent=None):
        ...
        self.interpolation = self.add_module(interpolation)
