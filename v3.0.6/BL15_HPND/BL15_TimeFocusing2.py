...
class TimeFocusing(RunWidget):
    def __init__(self, parent=None):
        ...
        self.load_beamline_config.auto_config(get_resource_path("CSNS_Alg/configure/BL15_small_base.json"))
        self.get_event_data = self.add_module(get_event_data, "Get Event Data")
        self.load_and_focus_test = self.add_module(load_and_focus, "Load and Time Focusing")
