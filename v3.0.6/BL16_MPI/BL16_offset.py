...
from BL16_MPI.workers.browse_file import browse_file
from BL16_MPI.workers.ui_mapping import save_offset_config,load_offset_config
...
class bl16_offset(QDialog, Ui_Form):
    def __init__(self, parent=None):
        ...
        self.paracheck_thread = BL16_MPI.workers.offset_thread.start_paracheck_process(self,self.paracheck_button)
        self.paracheck_button.clicked.connect(lambda: self.paracheck_thread.start_check(self.run_filePaths,))
        self.resultcheck_thread = BL16_MPI.workers.offset_thread.start_resultcheck_process(self, self.resultcheck_button)
