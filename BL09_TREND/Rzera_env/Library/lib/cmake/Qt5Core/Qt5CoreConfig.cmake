...
if (NOT TARGET Qt5::Core)
    ...
    set(Qt5Core_PRIVATE_INCLUDE_DIRS
        "${_qt5Core_install_prefix}/include/qt/QtCore/5.15.2"
        "${_qt5Core_install_prefix}/include/qt/QtCore/5.15.2/QtCore"
    )
    ...
    set_property(TARGET Qt5::Core
                 ...
                 datetimeparser;doubleconversion;hijricalendar;icu;mimetype-database;sha3-fast)
    set_property(TARGET Qt5::Core
                 PROPERTY QT_DISABLED_PRIVATE_FEATURES
                 clock-gettime;etw;futimens;futimes;getauxval;getentropy;glib;glibc;gnu-libiconv;iconv;inotify;journald;linkat;lttng;posix-libiconv;system-pcre2;renameat2;slog2;statx;syslog;system-doubleconversion)
